...
function createSleepPromise(timeout, { useCachedSetTimeout = false }) {
    const timeoutFunction = useCachedSetTimeout === true ? cachedSetTimeout : setTimeout;
...
export default function sleep(timeout, { useCachedSetTimeout = false } = {}) {
